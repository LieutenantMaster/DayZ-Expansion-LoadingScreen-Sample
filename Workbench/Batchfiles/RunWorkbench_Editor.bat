...
echo start %workbenchEXE% -gproj=%workDrive%%prefixLinkRoot%\Workbench\expansion_editor.gproj
start %workbenchEXE% -gproj=%workDrive%%prefixLinkRoot%\Workbench\expansion_editor.gproj
