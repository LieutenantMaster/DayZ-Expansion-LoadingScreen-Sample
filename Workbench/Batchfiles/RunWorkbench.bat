...
echo start %workbenchEXE% -gproj=%workDrive%%prefixLinkRoot%\Workbench\expansion.gproj
start %workbenchEXE% -gproj=%workDrive%%prefixLinkRoot%\Workbench\expansion.gproj
